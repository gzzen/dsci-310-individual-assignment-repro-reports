...
```{r horse-plot, fig.cap="Horse populations for all provinces in Canada from 1906 - 1972", out.width="100%", out.height="120%"}
...
```{r horses-sd-table, show_col_types = FALSE}
horses_sd_table <- read_csv("../../results/horses_sd.csv")
largest_sd <- horses_sd_table$Province[1]
knitr::kable(horses_sd_table, caption="Standard deviation for horse populations for all provinces")
```
...
Additionally, note that in Table \@ref(tab:horses-sd-table) we consider the sample standard deviation of the number of horses during the same time span as Figure \@ref(fig:horse-plot).

```{r maxsd-horse-plot, fig.cap="Horse populations for the province with the largest standard deviation", out.width="60%"}
